...
Revision ID: 95a81c68ab4a
Revises: 
Create Date: 2023-02-22 09:44:01.757971
...
def upgrade():
    ...
    op.create_table('owner',
                    ...
                    sa.Column('confirm_password', sa.String(
                        length=32), nullable=False),
    ...
    op.create_table('hotel',
                    ...
                    sa.ForeignKeyConstraint(
                        ['hotel_owner_id'], ['owner.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_table('pets',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('name', sa.String(length=50), nullable=False),
                    sa.Column('pet_type', sa.Enum('DOG', 'CAT', 'RODENT', 'BIRD',
                                                  'OTHER', 'ANY', name='pet_type'), nullable=False),
    ...
    op.create_table('review',
                    ...
                    sa.Column('rating', sa.Numeric(scale=2), nullable=False),
    ...
    op.create_table('room',
                    sa.Column('id', sa.Integer(), nullable=False),
                    sa.Column('pet_type', sa.Enum(
                        'DOG', 'CAT', 'RODENT', 'BIRD', 'OTHER', 'ANY', name='pet_type'), nullable=True),
                    sa.Column('hotel_id', sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['hotel_id'], ['hotel.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
