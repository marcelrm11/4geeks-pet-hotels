...
Revision ID: 4405b8118920
Revises: 
Create Date: 2023-03-02 12:08:52.356411
...
def upgrade():
    ...
    sa.Column('services', sa.String(length=250), nullable=False),
    sa.Column('base_price', sa.Numeric(scale=2), nullable=False),
